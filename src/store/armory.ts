...
export const PORT_ARMORY: Record<string, WeaponType[]> = {
  ...
  manila: ['cetbang', 'fireRocket', 'swivelGun', 'minion', 'saker'],
  nagasaki: ['swivelGun', 'falconet', 'minion', 'saker'],
  masulipatnam: ['lantaka', 'minion', 'demiCulverin'],
  ...
  venice: ['swivelGun', 'falconet', 'minion', 'saker'],
