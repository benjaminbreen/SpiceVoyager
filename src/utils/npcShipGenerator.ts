...
function familyForShipType(shipType: ShipType): ShipVisualFamily {
  if (shipType === 'Junk') return 'junk';
  if (shipType === 'Prau' || shipType === 'Jong') return 'prau';
  if (shipType === 'Carrack' || shipType === 'Galleon' || shipType === 'Pinnace' || shipType === 'Fluyt' || shipType === 'Armed Merchantman') return 'european';
  return 'dhow';
}
...
function sailPlanForShipType(shipType: ShipType): NPCShipVisual['sailPlan'] {
  if (shipType === 'Junk') return 'junk';
  if (shipType === 'Prau' || shipType === 'Jong') return 'lug';
  if (shipType === 'Carrack' || shipType === 'Galleon' || shipType === 'Armed Merchantman') return 'mixed';
  if (shipType === 'Fluyt' || shipType === 'Pinnace') return 'square';
  return 'lateen';
}
...
const TRADITIONS: Record<ShipTraditionId, ShipTradition> = {
  portuguese_estado: {
    ...
    shipTypes: [['Carrack', 32], ['Galleon', 18], ['Armed Merchantman', 30], ['Pinnace', 20]],
    cargo: [['Black Pepper', 20], ['Cinnamon', 14], ['Munitions', 18], ['Cotton Textiles', 12], ['Cloves', 10], ['Nutmeg', 8], ['Chinese Porcelain', 8], ['Rice', 10]],
  ...
  dutch_voc: {
    ...
    shipTypes: [['Fluyt', 34], ['Armed Merchantman', 28], ['Pinnace', 20], ['Galleon', 10], ['Junk', 8]],
    cargo: [['Cloves', 22], ['Nutmeg', 20], ['Black Pepper', 14], ['Munitions', 12], ['Chinese Porcelain', 10], ['Cotton Textiles', 10], ['Rice', 12]],
  ...
  english_eic: {
    ...
    shipTypes: [['Armed Merchantman', 44], ['Pinnace', 26], ['Galleon', 16], ['Carrack', 14]],
    cargo: [['Cotton Textiles', 18], ['Black Pepper', 18], ['Munitions', 15], ['Indigo', 13], ['Cloves', 10], ['Nutmeg', 8], ['Rice', 18]],
  ...
  gujarati_merchant: {
    ...
    shipTypes: [['Dhow', 30], ['Baghla', 18], ['Ghurab', 16], ['Pattamar', 22], ['Pinnace', 8], ['Armed Merchantman', 6]],
    cargo: [['Cotton Textiles', 28], ['Indigo', 16], ['Black Pepper', 14], ['Rice', 12], ['Iron', 8], ['Timber', 6], ['Cardamom', 6], ['Pearls', 5], ['Munitions', 5]],
  ...
  mughal_surati: {
    ...
    shipTypes: [['Ghurab', 28], ['Baghla', 24], ['Dhow', 20], ['Pattamar', 18], ['Armed Merchantman', 10]],
    cargo: [['Cotton Textiles', 22], ['Indigo', 18], ['Iron', 12], ['Opium', 10], ['Rice', 10], ['Pearls', 8], ['Munitions', 10], ['Black Pepper', 10]],
  ...
  omani_dhow: {
    ...
    shipTypes: [['Dhow', 42], ['Baghla', 26], ['Ghurab', 18], ['Pattamar', 8], ['Pinnace', 6]],
    cargo: [['Frankincense', 16], ['Myrrh', 12], ['Coffee', 12], ['Pearls', 10], ['Cotton Textiles', 10], ['Rice', 12], ['Black Pepper', 12], ['Munitions', 8], ['Timber', 8]],
  ...
  swahili_coaster: {
    ...
    shipTypes: [['Dhow', 56], ['Baghla', 16], ['Pattamar', 12], ['Prau', 8], ['Pinnace', 8]],
    cargo: [['Ivory', 18], ['Ambergris', 12], ['Cotton Textiles', 12], ['Rice', 14], ['Frankincense', 10], ['Myrrh', 8], ['Timber', 8], ['Black Pepper', 8], ['Munitions', 10]],
  ...
  ottoman_red_sea: {
    ...
    shipTypes: [['Dhow', 34], ['Baghla', 22], ['Ghurab', 18], ['Pinnace', 14], ['Armed Merchantman', 12]],
    cargo: [['Coffee', 24], ['Frankincense', 14], ['Myrrh', 10], ['Rose Water', 8], ['Munitions', 14], ['Rice', 12], ['Cotton Textiles', 10], ['Saffron', 8]],
  ...
  persian_gulf: {
    ...
    shipTypes: [['Baghla', 32], ['Dhow', 28], ['Ghurab', 22], ['Pattamar', 10], ['Pinnace', 8]],
    cargo: [['Pearls', 18], ['Rose Water', 14], ['Saffron', 12], ['Cotton Textiles', 12], ['Coffee', 10], ['Rice', 10], ['Munitions', 8], ['Frankincense', 8], ['Myrrh', 8]],
  ...
  malay_prau: {
    ...
    shipTypes: [['Prau', 48], ['Jong', 24], ['Dhow', 14], ['Junk', 14]],
    cargo: [['Cloves', 18], ['Nutmeg', 16], ['Benzoin', 12], ['Camphor', 10], ['Rice', 12], ['Chinese Porcelain', 10], ['Black Pepper', 10], ['Munitions', 12]],
  ...
  acehnese_raider: {
    ...
    shipTypes: [['Prau', 34], ['Jong', 24], ['Ghurab', 16], ['Dhow', 14], ['Pinnace', 12]],
    cargo: [['Munitions', 20], ['Cloves', 16], ['Nutmeg', 12], ['Black Pepper', 12], ['Benzoin', 10], ['Rice', 10], ['Camphor', 10], ['Cotton Textiles', 10]],
  ...
  javanese_jong: {
    ...
    shipTypes: [['Jong', 42], ['Prau', 22], ['Junk', 16], ['Dhow', 12], ['Pinnace', 8]],
    cargo: [['Rice', 18], ['Cloves', 16], ['Nutmeg', 14], ['Benzoin', 12], ['Camphor', 10], ['Black Pepper', 10], ['Chinese Porcelain', 10], ['Munitions', 10]],
  ...
  chinese_junk: {
    ...
    shipTypes: [['Junk', 82], ['Jong', 12], ['Prau', 6]],
    cargo: [['Chinese Porcelain', 24], ['Tea', 18], ['Camphor', 12], ['Benzoin', 10], ['Cloves', 8], ['Nutmeg', 8], ['Rice', 12], ['Munitions', 8]],
  ...
  japanese_red_seal: {
    ...
    shipTypes: [['Junk', 42], ['Armed Merchantman', 18], ['Pinnace', 16], ['Prau', 14], ['Jong', 10]],
    cargo: [['Chinese Porcelain', 16], ['Tea', 14], ['Munitions', 16], ['Cloves', 12], ['Nutmeg', 10], ['Cotton Textiles', 10], ['Rice', 12], ['Camphor', 10]],
...
function makeAppearancePhrase(tradition: ShipTradition, role: RouteRole, shipType: ShipType, morale: number): string {
  const roleText = role === 'blue-water merchant' ? 'merchant' : role;
...
function generateVisual(tradition: ShipTradition, shipType: ShipType, morale: number): NPCShipVisual {
  ...
  return {
    ...
    hasOutrigger: shipType === 'Prau',
    hasCannonPorts: tradition.armament > 0.5 || shipType === 'Galleon' || shipType === 'Armed Merchantman' || shipType === 'Ghurab',
    hasSternCastle: shipType === 'Carrack' || shipType === 'Galleon' || shipType === 'Junk' || shipType === 'Jong',
