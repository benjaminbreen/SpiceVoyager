...
const TRADITIONS: Record<ShipTraditionId, ShipTradition> = {
  portuguese_estado: {
    ...
    cargo: [['Black Pepper', 20], ['Cinnamon', 14], ['Munitions', 18], ['Cloves', 10], ['Nutmeg', 8], ['Chinese Porcelain', 8], ['Rice', 10]],
  ...
  dutch_voc: {
    ...
    cargo: [['Cloves', 22], ['Nutmeg', 20], ['Black Pepper', 14], ['Munitions', 12], ['Chinese Porcelain', 10], ['Rice', 12]],
  ...
  english_eic: {
    ...
    cargo: [['Black Pepper', 18], ['Munitions', 15], ['Indigo', 13], ['Cloves', 10], ['Nutmeg', 8], ['Rice', 18]],
  ...
  gujarati_merchant: {
    ...
    cargo: [['Indigo', 16], ['Black Pepper', 14], ['Rice', 12], ['Iron', 8], ['Timber', 6], ['Cardamom', 6], ['Pearls', 5], ['Munitions', 5]],
  ...
  mughal_surati: {
    ...
    cargo: [['Indigo', 18], ['Iron', 12], ['Opium', 10], ['Rice', 10], ['Pearls', 8], ['Munitions', 10], ['Black Pepper', 10]],
  ...
  omani_dhow: {
    ...
    cargo: [['Frankincense', 16], ['Myrrh', 12], ['Coffee', 12], ['Pearls', 10], ['Rice', 12], ['Black Pepper', 12], ['Munitions', 8], ['Timber', 8]],
  ...
  swahili_coaster: {
    ...
    cargo: [['Ivory', 18], ['Ambergris', 12], ['Rice', 14], ['Frankincense', 10], ['Myrrh', 8], ['Timber', 8], ['Black Pepper', 8], ['Munitions', 10]],
  ...
  ottoman_red_sea: {
    ...
    cargo: [['Coffee', 24], ['Frankincense', 14], ['Myrrh', 10], ['Rose Water', 8], ['Munitions', 14], ['Rice', 12], ['Saffron', 8]],
  ...
  persian_gulf: {
    ...
    cargo: [['Pearls', 18], ['Rose Water', 14], ['Saffron', 12], ['Coffee', 10], ['Rice', 10], ['Munitions', 8], ['Frankincense', 8], ['Myrrh', 8]],
  ...
  acehnese_raider: {
    ...
    cargo: [['Munitions', 20], ['Cloves', 16], ['Nutmeg', 12], ['Black Pepper', 12], ['Benzoin', 10], ['Rice', 10], ['Camphor', 10]],
  ...
  japanese_red_seal: {
    ...
    cargo: [['Chinese Porcelain', 16], ['Tea', 14], ['Munitions', 16], ['Cloves', 12], ['Nutmeg', 10], ['Rice', 12], ['Camphor', 10]],
  ...
  spanish_atlantic: {
    ...
    cargo: [['Sugar', 20], ['Tobacco', 14], ['Munitions', 14], ['Iron', 10], ['Rice', 10], ['Black Pepper', 8], ['Chinese Porcelain', 8], ['Indigo', 6]],
  ...
  french_atlantic: {
    ...
    cargo: [['Sugar', 16], ['Tobacco', 14], ['Munitions', 14], ['Iron', 10], ['Rice', 10], ['Black Pepper', 8], ['Timber', 8], ['Indigo', 8]],
  ...
  english_atlantic: {
    ...
    cargo: [['Munitions', 16], ['Iron', 14], ['Tobacco', 12], ['Sugar', 10], ['Rice', 10], ['Timber', 8], ['Black Pepper', 8], ['Indigo', 8]],
    hullPalettes: [[{ hullColor: '#352d28', trimColor: '#b83b2e', deckColor: '#6d5239' }, 55], [{ hullColor: '#273238', trimColor: '#d0b165', deckColor: '#66513a' }, 45]],
    sailPalettes: [[{ sailColor: '#d1c4a6', sailTrimColor: '#b83b2e' }, 55], [{ sailColor: '#c5b798', sailTrimColor: '#f0e1bb' }, 45]],
    flagPalettes: [[{ flagColor: '#d8e1e8', flagAccentColor: '#b72828' }, 80], [{ flagColor: '#b72828', flagAccentColor: '#d8e1e8' }, 20]],
    armament: 0.55,
  ...
  portuguese_atlantic: {
    ...
    cargo: [['Sugar', 22], ['Tobacco', 12], ['Black Pepper', 10], ['Munitions', 10], ['Rice', 8], ['Iron', 8], ['Timber', 8], ['Ivory', 6], ['Indigo', 4]],
    hullPalettes: [[{ hullColor: '#3f3027', trimColor: '#9b2f25', deckColor: '#6d4c32' }, 55], [{ hullColor: '#252527', trimColor: '#d6c18f', deckColor: '#6b4a31' }, 45]],
    sailPalettes: [[{ sailColor: '#d8c7a2', sailTrimColor: '#9b2f25' }, 65], [{ sailColor: '#c9b694', sailTrimColor: '#ddd2b5' }, 35]],
    flagPalettes: [[{ flagColor: '#f3ead8', flagAccentColor: '#b82923' }, 80], [{ flagColor: '#b82923', flagAccentColor: '#f3ead8' }, 20]],
    armament: 0.52,
  ...
  dutch_atlantic: {
    ...
    cargo: [['Sugar', 16], ['Munitions', 14], ['Iron', 12], ['Tobacco', 10], ['Rice', 10], ['Timber', 10], ['Black Pepper', 8], ['Cloves', 8]],
    hullPalettes: [[{ hullColor: '#2d342f', trimColor: '#d29539', deckColor: '#6a563d' }, 60], [{ hullColor: '#30343b', trimColor: '#c8b37c', deckColor: '#67513a' }, 40]],
    sailPalettes: [[{ sailColor: '#d2c3a4', sailTrimColor: '#d29539' }, 70], [{ sailColor: '#bbb3a0', sailTrimColor: '#5d6b74' }, 30]],
    flagPalettes: [[{ flagColor: '#d6673b', flagAccentColor: '#f4e5c6' }, 65], [{ flagColor: '#f4e5c6', flagAccentColor: '#345c85' }, 35]],
    armament: 0.5,
  ...
  local_caribbean: {
    ...
    cargo: [['Sugar', 20], ['Tobacco', 20], ['Rice', 14], ['Timber', 12], ['Iron', 8], ['Munitions', 8], ['Indigo', 8]],
