...
export const WATER_PALETTES: Record<WaterPaletteId, WaterPalette> = {
  ...
  monsoon: {
    id: 'monsoon',
    label: 'Monsoon',
    description: 'Humid jade estuary water with pale silty shallows and localized river murk.',
    terrain: {
      deep: [0.00, 0.18, 0.30],
      shallow: [0.08, 0.62, 0.52],
      surf: [0.58, 0.82, 0.62],
    },
    oceanOverlay: {
      base: [0.01, 0.32, 0.34],
      outerShallow: [0.08, 0.56, 0.48],
      paleSurf: [0.50, 0.78, 0.58],
    },
    surface: {
      day: [0.00, 0.25, 0.34],
      dusk: [0.00, 0.16, 0.24],
      night: [0.00, 0.03, 0.06],
      fallbackHex: 0x004056,
    },
    map: {
      deep: [0.00, 0.18, 0.28],
      shallow: [0.12, 0.48, 0.42],
    },
  },
  arid: {
    id: 'arid',
  ...
  mediterranean: {
    id: 'mediterranean',
    label: 'Tagus Blue',
    description: 'Clear Atlantic-blue estuary water with bright sunlit cyan shallows.',
    terrain: {
      deep: [0.00, 0.22, 0.56],
      shallow: [0.02, 0.74, 0.90],
      surf: [0.70, 0.98, 1.00],
    },
    oceanOverlay: {
      base: [0.02, 0.34, 0.64],
      outerShallow: [0.04, 0.62, 0.86],
      paleSurf: [0.62, 0.94, 1.00],
    },
    surface: {
      day: [0.00, 0.30, 0.66],
      dusk: [0.01, 0.20, 0.46],
      night: [0.00, 0.03, 0.08],
      fallbackHex: 0x004daa,
    },
    map: {
      deep: [0.00, 0.26, 0.58],
      shallow: [0.08, 0.64, 0.86],
    },
  },
};
