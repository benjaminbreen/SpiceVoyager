...
export const WATER_PALETTES: Record<WaterPaletteId, WaterPalette> = {
  ...
  temperate: {
    id: 'temperate',
    label: 'Temperate',
    description: 'Cold slate-green ocean water with muted grey coastal shallows.',
    terrain: {
      deep: [0.08, 0.17, 0.21],
      shallow: [0.25, 0.34, 0.34],
      surf: [0.56, 0.62, 0.58],
    },
    oceanOverlay: {
      base: [0.22, 0.34, 0.34],
    ...
    surface: {
      day: [0.07, 0.20, 0.26],
      dusk: [0.05, 0.13, 0.18],
      night: [0.01, 0.03, 0.05],
      fallbackHex: 0x123342,
    },
    map: {
      deep: [0.10, 0.21, 0.27],
      shallow: [0.23, 0.32, 0.34],
    },
  },
  mediterranean: {
    id: 'mediterranean',
