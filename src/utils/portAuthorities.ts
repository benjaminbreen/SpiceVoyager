...
export const PORT_AUTHORITIES: Record<string, PortAuthority> = {
  ...
  veracruz: {
    portId: 'veracruz',
    label: 'Royal Officials of Veracruz',
    office: 'Alcalde mayor, treasury, and fleet customs officers',
    authorityKind: 'crown-office',
    buildingLabel: 'Casa Real de Veracruz',
    buildingSub: 'New Spanish treasury and customs',
    creditPatron: 'Veracruz royal treasury',
    commissionStyle: 'state',
    note: 'Veracruz is the Atlantic gate of New Spain. A trader petitions royal officials tied to the flota, customs, and the road inland to Mexico City.',
  },
  manila: {
    portId: 'manila',
  ...
  colombo: {
    portId: 'colombo',
    label: 'Portuguese Captain of Colombo',
    office: 'Fort captain and cinnamon customs officers',
    authorityKind: 'fort-captain',
    buildingLabel: 'Colombo Captaincy',
    buildingSub: 'Portuguese Ceylon authority',
    creditPatron: 'Colombo cinnamon factors',
    commissionStyle: 'customs',
    note: 'Colombo trade runs through the Portuguese fort and cinnamon officials, but the cinnamon country depends on local labor, brokers, and contested inland politics.',
  },
  aden: {
    portId: 'aden',
