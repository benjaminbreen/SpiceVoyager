...
// Six-keyframe time-of-day palette shared by the splash globe and any port-side
// sky scene. `phase` is normalized to [0, 1):
//   0.00 = dawn   0.18 = morning   0.50 = afternoon
//   0.72 = sunset 0.86 = dusk      1.00 wraps back to dawn
const DAY_KEYS = [
  { p: 0.00, top: '#7d4d6f', horizon: '#f7c08a', sun: '#ffd198', cool: '#5b6e8a', sunI: 1.4,  ambI: 0.55, stars: 0.25 },
  { p: 0.18, top: '#79b3dd', horizon: '#f8e6c4', sun: '#fff7e2', cool: '#bcd6e6', sunI: 1.65, ambI: 0.7,  stars: 0.0  },
  { p: 0.50, top: '#5485b6', horizon: '#bfd6e8', sun: '#fff4d0', cool: '#9bbfd8', sunI: 1.7,  ambI: 0.7,  stars: 0.0  },
  { p: 0.72, top: '#3a5277', horizon: '#f1956a', sun: '#ff9764', cool: '#8a5a72', sunI: 1.5,  ambI: 0.6,  stars: 0.35 },
  { p: 0.86, top: '#1a1a3a', horizon: '#3a2a4a', sun: '#9b88c0', cool: '#3a4a6c', sunI: 0.35, ambI: 0.32, stars: 1.0  },
  { p: 1.00, top: '#7d4d6f', horizon: '#f7c08a', sun: '#ffd198', cool: '#5b6e8a', sunI: 1.4,  ambI: 0.55, stars: 0.25 },
];
